...
O código do projeto foi escrito em Python e está disponível no repositório GitHub: https://github.com/HgrassM/Trab-2-Seg-Comp. Não é necessário instalar bibliotecas adicionais para executar o código, pois todas as funcionalidades foram implementadas utilizando apenas bibliotecas padrão do Python.
